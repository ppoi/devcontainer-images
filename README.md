...
- non-root user dedicated for vscode(uid=1000).
...
| MAVEN_VERSION | installed Apache Maven version | 3.9.13 | BRAVO, CHARLIE |
...
| maven | `install-maven.sh [<MAVEN_VERSION>]` | Install Maven(default:3.9.13). |
